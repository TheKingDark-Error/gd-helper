...
public:
    ...
    void update(float dt) {
        ...
        float la = 4.0f;
        switch (m_mode) {
            case GameMode::Ship: la = 6.0f; break;
            case GameMode::Wave: la = 3.0f; break;
            case GameMode::UFO: la = 4.0f; break;
            default: break;
        }
